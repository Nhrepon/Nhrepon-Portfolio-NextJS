    ...
    return (
        <div className="w-full mx-auto">
            ...
            <div className="flex flex-col gap-4 my-8 w-full max-w-[600px] mx-auto">
                ...
                <input type="text" name="image" id="image" placeholder="Image URL" className="border-2 border-gray-300 rounded-md p-2"/>
                <button className="bg-green-700 hover:bg-green-800 cursor-pointer w-fit mx-auto text-white py-2 px-4 rounded">Save</button>
            </div>
        </div>
    )
};
