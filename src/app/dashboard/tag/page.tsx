                  ...
                  {tagList.map((tag:any, index:number) => (
                    <tr key={index}>
                      ...
                      <div className='flex gap-2 rounded justify-end'>
                        <span onClick={() => handleEdit(tag._id)} className='text-green-700 cursor-pointer p-2 bg-gray-300 hover:bg-gray-400 rounded'>
                        <i className='bi bi-pencil'></i>
                        </span>
                        <span onClick={() => handleDelete(tag._id)} className='text-red-600 cursor-pointer p-2 bg-gray-300 hover:bg-gray-400 rounded'>
