...
const Modal = ({children, text="Add", heading = "Add/Update Item"}: ModalProps) => {
    ...
    return (
        <div>
            <button className="bg-green-700 hover:bg-green-800 cursor-pointer text-white py-2 px-4 rounded" onClick={openModal}>{text}</button>
            {
                isModalVisible && (
                    ...
                    <div className="fixed flex justify-center items-center top-0 left-0 w-full h-full" style={{background: "rgba(0, 0, 0, 0.7)", zIndex: 10}}>
                        <div className="bg-white mx-auto shadow-xl relative p-3 w-9/12 max-w-[600px] max-h-[80vh] rounded-lg">
